...
void setup()
{
  ...
  if (c == 0x71) // WHO_AM_I should always be 0x68
  {
    ...
    EEPROM.get(magCorrectionEEPROMaddress, magCorrections);
...
void loop()
{
  ...
  if (myIMU.readByte(MPU9250_ADDRESS, INT_STATUS) & 0x01)
  {
    ...
    myIMU.magbias[2] = magBias.xz; // +125.;
...
void magcalMPU9250(float * dest1, float * dest2)
{
  ...
  for (ii = 0; ii < sample_count; ii++) {
    ...
    magCorrections.x =  dest1[0];
    magCorrections.y =  dest1[1];
    magCorrections.z =  dest1[2];
    ...
    EEPROM.put(magCorrectionEEPROMaddress, magCorrections);
    EEPROM.put(magBiasEEPROMaddress, magBias);

    Serial.println("MagCorrect XYZ");
    Serial.print(magCorrections.x); Serial.print(", "); Serial.print(magCorrections.y);
    Serial.print(", "); Serial.print(magCorrections.z);     Serial.println("MagBias XYZ");
