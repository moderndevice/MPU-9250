...
void magcalMPU9250(float * dest1, float * dest2)
{
  ...
  for (ii = 0; ii < sample_count; ii++) {
    ...
    magCorrections.x =  dest2[0];
    magCorrections.y =  dest2[1];
    magCorrections.z =  dest2[2];

    EEPROM.put(eeAddress, magCorrections);
    EEPROM.get(eeAddress, testCorrections);

    Serial.println("Mag Corrections X Y Z ");

    Serial.print(testCorrections, x);
    Serial.print(", ");
    Serial.print(testCorrections, y);
    Serial.print(", ");
    Serial.println(testCorrections, z);
  }
}
