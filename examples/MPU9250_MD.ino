...
int pwrPin = 2; // Use a pin for power so we can reset the chip. We shouldn't have to do this.
...
void resetBoard() // turn the power on and off
{
...
//  MahonyQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f, my, mx, mz);
    ...
    delt_t = millis() - count;
    if(delt_t > 50) {
    // Print order: Xaccel, Yaccel, Zaccel, Xgyro, Ygyro, Zgyro, Xmag, Ymag, Zmag, Temp.
    /*Serial.print(1000*ax); Serial.print(",");Serial.print(1000*ay); Serial.print(",");Serial.print(1000*az); Serial.print(",");
