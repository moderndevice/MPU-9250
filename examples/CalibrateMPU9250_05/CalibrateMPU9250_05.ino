...
byte magCorrectionEEPROMaddress = 0;
...
byte magBiasEEPROMaddress = sizeof(magCorrection);

float mag_scale[3] = {0, 0, 0};
const int EEPROM_MAG_CALIB_ADDRESS = 500;   //EEPROM location where we want the calibration data - don't overwrite this.
